...
function business_customize_register($wp_customize){
	...
	// Box 1
		...
		$wp_customize->add_control('box1_heading', array(
			'label'		=> _x('Box 1 Heading','business'),
			'section'	=> 'boxes',
			'priority'	=> 20,
		));
	...
	// Box 2
		...
		$wp_customize->add_control('box2_heading', array(
			'label'		=> _x('Box 2 Heading','business'),
			'section'	=> 'boxes',
			'priority'	=> 20,
		));
		...
		$wp_customize->add_setting('box2_text', array(
			'default'	=> _x('Maecenas sed diam eget rigius various blandit sit amet non magna.','business'),
			'type'		=> 'theme_mod' 
		));

		// Box 2 Text Control
		$wp_customize->add_control('box2_text', array(
			'label'		=> _x('Box 2 Text','business'),
			'section'	=> 'boxes',
			'priority'	=> 20,
		));
	...
	// Box 3
		...
		$wp_customize->add_control('box3_heading', array(
			'label'		=> _x('Box 3 Heading','business'),
			'section'	=> 'boxes',
			'priority'	=> 20,
		));
